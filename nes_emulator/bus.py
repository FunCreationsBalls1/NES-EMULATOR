...
@dataclass
class Bus:
    """NES CPU bus with RAM mirroring, PPU/APU regs, controller IO, and cartridge mapping."""
    ...
    def write(self, addr: int, value: int) -> None:
        ...
        if 0x4000 <= addr <= 0x4013:
            # Pulse/triangle/noise/DMC register latches not yet synthesized.
            return
        if addr == 0x4014:
            start = value << 8
